...
<body data-spy="scroll" data-target="#navbar" data-offset="56">
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
                <div class="card">
                <svg class="card-img-top" xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-shop-window" viewBox="0 0 16 16">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="products.php">Productos</a></h5>
